...
export class ApiError extends GristError {
  constructor(
    ...
    super(
      ...
      { ...context, statusCode, method, path }
    )
  }
  ...
  toUserMessage(): string {
    ...
    switch (this.statusCode) {
      case 400:
        return `Bad request to ${this.method} ${this.path}\n\n` +
               `The request was malformed or contained invalid parameters.\n` +
               `Error: ${this.message}\n\n` +
               `Please check your input parameters and try again.`

      case 401:
        return `Authentication failed for ${this.method} ${this.path}\n\n` +
      ...
      case 403:
        return `Permission denied for ${this.method} ${this.path}\n\n` +
      ...
      case 404:
        return `Resource not found: ${this.method} ${this.path}\n\n` +
      ...
      case 503:
      case 504:
        return `Grist server error (${this.statusCode})\n\n` +
      ...
      default:
        return `Request failed: ${this.method} ${this.path}\n\n` +
