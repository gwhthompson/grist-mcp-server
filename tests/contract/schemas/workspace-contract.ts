 ...
 */
export const WorkspaceSummaryContractSchema = z.object({
 ...
 */
export const ColumnContractSchema = z.object({
...
export const TableContractSchema = z.object({
  ...
  fields: z
    .object({
      ...
      recordCardViewSectionRef: z.number().optional().describe('Record card view section reference'),
 ...
 */
export const TableListContractSchema = z.object({
 ...
 */
export const ColumnListContractSchema = z.object({
 ...
 */
export const RecordsListContractSchema = z.object({
