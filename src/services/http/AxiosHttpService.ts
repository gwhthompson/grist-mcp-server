 ...
 *
 * Concrete implementation of HttpService using Axios
 * Single responsibility: Make HTTP requests
 */
...
export class AxiosHttpService implements HttpService {
  ...
  constructor(
    ...
    this.client = axios.create({
      ...
      timeout,
      validateStatus: (status) => status < 500 // Don't throw on 4xx, let caller handle
    })
  }
