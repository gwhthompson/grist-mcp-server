 ...
 *
 * Provides simple, production-ready utilities for creating and validating
 * Grist CellValues based on the official GristObjCode specification.
 *
 * These helpers are designed for:
 * 1. TypeScript/JavaScript developers using this package as a library
 * 2. Test code and examples
 * 3. Self-documenting CellValue encoding
 *
 * @module encoding/cell-value-helpers
 * @see docs/reference/grist-types.d.ts for GristObjCode specification
 */
