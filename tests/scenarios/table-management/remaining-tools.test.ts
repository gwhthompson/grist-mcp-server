...
describe('Remaining Tools - Complete Integration Tests', () => {
  ...
  describe('grist_create_table', () => {
    it('should create a new table with columns', async () => {
      const result = await tables.createTable(context.toolContext, {
        docId: context.docId,
    ...
    it('should handle table name validation errors', async () => {
      ...
      expect(result).toHaveErrorResponse(/Invalid TableId format|validation/i)
    })
  ...
  describe('grist_rename_table', () => {
    ...
    beforeEach(async () => {
      ...
      const createResult = await tables.createTable(context.toolContext, {
        docId: context.docId,
    ...
    it('should rename a table successfully', async () => {
      ...
      const result = await tables.renameTable(context.toolContext, {
        docId: context.docId,
        tableId: testTableId,
        newTableId: newName,
        response_format: 'json'
  ...
  describe('grist_delete_table', () => {
    ...
    it('should delete a table successfully', async () => {
      const result = await tables.deleteTable(context.toolContext, {
        docId: context.docId,
        tableId: testTableId,
        response_format: 'json'
      })
  ...
  describe('grist_create_document', () => {
    ...
    it('should create a new blank document', async () => {
      ...
      const result = await documents.createDocument(context.toolContext, {
        name: docName,
    ...
    it('should create a forked document', async () => {
      ...
      const sourceTables = await discovery.getTables(context.toolContext, {
        docId: context.docId,
        detail_level: 'names',
        response_format: 'json'
      })
    ...
    it('should handle document name validation', async () => {
      ...
      expect(result).toHaveErrorResponse(/name|validation|required/i)
    })
  })
  ...
  describe('Cross-tool Integration', () => {
    it('should create document, add table, rename it, and delete it', async () => {
      // 1. Create document
      const docResult = await documents.createDocument(context.toolContext, {
      ...
      try {
        // 2. Create table
        const tableResult = await tables.createTable(context.toolContext, {
          docId,
        ...
        // 3. Rename table
        const renameResult = await tables.renameTable(context.toolContext, {
          docId,
        ...
        const tablesBeforeDelete = await discovery.getTables(context.toolContext, {
          docId,
          detail_level: 'names',
          response_format: 'json'
        })
        ...
        // 5. Delete table
        const deleteResult = await tables.deleteTable(context.toolContext, {
          docId,
        ...
        const tablesAfterDelete = await discovery.getTables(context.toolContext, {
          docId,
          detail_level: 'names',
          response_format: 'json'
        })
